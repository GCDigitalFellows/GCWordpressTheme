...
function setup_framework_options(){
    ...
    $sections[] = array(
        ...
        'desc' => __('<p class="description">Configure the header layout and styles</p>', Redux_TEXT_DOMAIN),
        'fields' => array(
            array(
                'id' => 'opt-header-scroll',
                'type' => 'select',
                'title' => __('Position', Redux_TEXT_DOMAIN),
                'desc' => __('Should the header be affixed at the top of the page or scroll with the page?', Redux_TEXT_DOMAIN),
				'options' => array("scroll" => "Scroll","fixed" => "Fixed"),
                'default' => 'scroll'
			),

			array( 'title' => __('Header Background', Redux_TEXT_DOMAIN),
			...
			array( 'title' => __('Header text color', Redux_TEXT_DOMAIN),
					...
					'type' => 'link_color',
					'output' => '.navbar-default .navbar-brand',
					'validate' => 'color'
			),
			array( 'title' => __('Menu font color', Redux_TEXT_DOMAIN),
					...
					'type' => 'link_color',
					'output' => '.navbar-default .navbar-nav>li>a',
					'validate' => 'color'
			),
			...
			array( 'title' => __('University Branding', Redux_TEXT_DOMAIN),
