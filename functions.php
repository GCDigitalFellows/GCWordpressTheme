...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
		if (!is_admin()){
        wp_register_style( 'bootstrap', get_template_directory_uri() . '/library/theme/css/bootstrap-themed.css', array(), '3.0.3.4', 'all' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
	  ...
	  //use CDN for loading Bootstrap
	    ...
	    wp_register_script( 'wpbs-scripts', get_template_directory_uri() . '/library/js/scripts.js',array('jquery'),'0.1.2', true );
