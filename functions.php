...
if( !function_exists("theme_styles") ) {  
    function theme_styles() { 
		if (!is_admin()){
        wp_register_style( 'bootstrap', get_template_directory_uri() . '/library/theme/css/bootstrap-themed.css', array(), '3.0.3.5', 'all' );
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
	  ...
	  //use CDN for loading Bootstrap
	    ...
	    wp_register_script( 'waypoints', get_template_directory_uri() . '/library/js/jquery-waypoints/waypoints.min.js', array('jquery'), '2.0.4', true);
